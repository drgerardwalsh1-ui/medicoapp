//! Contradiction Engine graph narratives — PURE deterministic summarisation of
...
use crate::contradiction_cluster_graph::ClusterGraph;
use crate::cluster_graph_analysis::{ClinicalSignificance, GraphAnalytics, NodeMetric};
...
pub fn build_graph_narrative(graph: &ClusterGraph, analytics: &GraphAnalytics) -> GraphNarrative {
...
mod tests {
    use super::*;
    use crate::contradiction_enrichment::CrossNamespaceRelation;
    use crate::contradiction_cluster_graph::{GraphEdge, GraphNode, ClusterGraph};
    use crate::cluster_graph_analysis::analyze_graph;
    ...
    fn narrative() -> (ClusterGraph, GraphAnalytics, GraphNarrative) {
        let g = mk_graph();
