//! Contradiction Engine monitoring queue — deterministic organisation of contradictions for
...
use crate::contradiction_forecast_readiness::{ForecastReadinessLevel, ForecastReadinessReport};
...
mod tests {
    ...
    fn high_priority_query_sorted() {
        ...
        let snaps: Vec<ContradictionReportSnapshot> = (1..=5)
