//! Contradiction Engine forecast readiness — deterministic classification of whether a
...
use crate::contradiction_report_history::ReportHistory;
use crate::contradiction_report_trends::{ReportTrends, TrendDirection};
...
mod tests {
    ...
    fn report_of(snaps: &[ContradictionReportSnapshot]) -> ForecastReadinessReport {
