//! Contradiction Engine snapshot filesystem backend — the first concrete `SnapshotRepository`
...
pub fn load_all_snapshots(base_path: &str) -> Vec<ContradictionReportSnapshot> {
...
mod tests {
    ...
    fn temp_dir(name: &str) -> String {
        ...
        p.push(format!("contradiction_file_repo_test_{name}"));
    ...
    fn repository_interface_compliance_with_file_backend() {
        ...
        use crate::contradiction_snapshot_repository::{newest_snapshot, repository_is_consistent, snapshot_exists};
