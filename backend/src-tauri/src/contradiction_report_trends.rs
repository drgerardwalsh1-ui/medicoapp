//! Contradiction Engine trend analytics — deterministic, read-only classification of how each
...
fn confidence_sequences(
    snapshots: &[ContradictionReportSnapshot],
...
pub fn build_report_trends(snapshots: &[ContradictionReportSnapshot]) -> ReportTrends {
