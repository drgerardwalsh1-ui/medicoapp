//! Contradiction Engine monitoring dashboard — a deterministic, read-only AGGREGATION over an
...
use crate::contradiction_forecast_readiness::ForecastReadinessLevel;
use crate::contradiction_monitoring_queue::{MonitoringPriority, MonitoringQueue};
use crate::contradiction_report_trends::TrendDirection;
...
mod tests {
    ...
    use crate::contradiction_forecast_readiness::build_forecast_readiness;
    use crate::contradiction_monitoring_queue::build_monitoring_queue;
    use crate::contradiction_report::build_contradiction_report;
    use crate::contradiction_report_history::build_report_history;
    use crate::contradiction_report_snapshot::{build_report_snapshot, ContradictionReportSnapshot};
    use crate::contradiction_report_trends::build_report_trends;
    ...
    fn queue_of(snaps: &[ContradictionReportSnapshot]) -> MonitoringQueue {
    ...
    fn mixed() -> Vec<ContradictionReportSnapshot> {
        vec![
